    ...
    <div style="text-align:center">
        <table cellpadding="3" cellspacing="0" style="margin: auto">
            <tr>
                <th rowspan="2">
                    <img class="image"
                         src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/79ed6663b57e30554a5d1f0653c68b78.jpg?thumb=1&w=234&h=614&f=webp&q=90">
                </th>
            ...
            <tr>
                <th v-for="(good, index) in goods.slice(4,8)" :key="index">
                    <good-item :product="good"/>
                </th>
            </tr>
        </table>
